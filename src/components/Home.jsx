...
export default function Home({ darkMode }) {
    ...
    return (
        <div className={`font-marker lg:mt-32 md:m-32  m-5 sm:mx-6 md:mx-16 lg:mx-12 xl:mx-32 flex flex-wrap gap-10 item-center justify-evenly  min-h-screen ${darkMode ? 'text-orange-200' : 'text-black'}`}>
            <div className={`flex mt-20 sm:flex-row md:flex-col lg:flex-col gap-7 items-center`}>
            ...
            <div className={`flex flex-col flex-wrap gap-5 max-w-xl text-wrap leading-loose lg:text-left md:text-center sm:text-center`}>
                ...
                <div>
                    <a href="https://www.linkedin.com/in/mukul-dixit-8b945227b/" target='_blank' className={`flex flex-wrap text-center justify-evenly p-2 mt-16 rounded-lg text-red-600 ${darkMode ? 'bg-orange-200  shadow-orange-900 hover:shadow-orange-300' : 'bg-black  shadow-gray-700 hover:shadow-black'}  shadow-lg  transition duration-300 hover:shadow-2xl hover:scale-105 px-4`}>Hi, we could connect on Linked In<h1 className='pt-2 text-sky-600'><FaLinkedin /></h1> </a>
                </div>
            </div>
