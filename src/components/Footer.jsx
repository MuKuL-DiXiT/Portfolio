...
export default function Footer({ darkMode }) {
    return (
        <div className={` mt-5 border-t-2 lg:text-2xl md:text-2xl sm:text-xl flex flex-col items-center flex-wrap ${darkMode ? 'text-orange-200 border-b-orange-200' : 'text-black border-t-black'}  justify-evenly rounded-full `}>
            <div className='flex gap-5'>
                ...
                <a href="https://leetcode.com/mukul2427/" target="_blank" rel="noopener noreferrer">
                    <img src="https://upload.wikimedia.org/wikipedia/commons/a/ab/LeetCode_logo_white_no_text.svg"
                        alt="LeetCode Profile" className="w-5 bg-black rounded" />
                </a>
            ...
            <div className='flex gap-2'>
                Created By <span className="text-red-600">
        <Typewriter
          options={{
            strings: ["Mukul Dixit"],
            autoStart: true,
