...
import { SiTailwindcss, SiExpress, SiMongodb, SiMongoose, SiSocketdotio, SiMysql, SiGit, SiJsonwebtokens, SiCplusplus, SiC, SiGithub, SiNextdotjs, SiPostman } from "react-icons/si";
      ...
      <div className="flex flex-wrap justify-center max-w-4xl gap-6 relative z-10">
        {skills.map((skill, idx) => (
          <motion.div
            ...
            initial="hidden"
            animate={controls}
            className={`skill-box w-28 h-28 flex flex-col items-center justify-center gap-1 rounded-xl shadow-lg backdrop-blur-md border will-change-transform ${
              darkMode
